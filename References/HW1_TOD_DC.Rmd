...
author: "Tianxiao Chen & Ling Chen"
date: '2023-09-10'
...
census_api_key("acc7865bbb75d743da30b4c1278b0d95cb3062db", overwrite = TRUE, install = TRUE)
```
...
Tracts 2019 is now complete. Let's grab 2009 tracts and do the same
thing.
...
#crs is in feet, so 2640=half of a mile
